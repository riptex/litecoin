...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.afkcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.afkcointools.com", true);
        vSeeds.emplace_back("dnsseed.afkcoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.afkcointools.com", true);
        vSeeds.emplace_back("seed-b.afkcoin.loshan.co.uk", true);
