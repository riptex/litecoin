...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s afkcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  afkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded afkcoin transaction") + "\n" +
              "  afkcoin-tx [options] -create [commands]   " + _("Create hex-encoded afkcoin transaction") + "\n" +
              "\n";
