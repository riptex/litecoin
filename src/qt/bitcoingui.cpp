...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and afkcoin: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a afkcoin: URI or payment request"));
